...
extern "C" {
  ...
  void impl_frtrace_gather_system_metadata();
  #define frtrace_gather_system_metadata() impl_frtrace_gather_system_metadata()
...
#ifndef frtrace_gather_system_metadata
  #define frtrace_gather_system_metadata()
#endif /* frtrace_gather_system_metadata */
